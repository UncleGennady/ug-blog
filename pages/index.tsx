...
export default function Home({posts, lastComments}:{posts:IPost[], lastComments: IComment[]}) {
    ...
    const renderPosts = (posts:IPost[]) =>{
        return (posts.map((post:IPost)=>(
            ...
            >
                ...
                <div className={`${styles.info} ${theme === 'dark' ? styles.info_dark : ''}`}>
                    ...
                    <h4 className={`${styles.tags_card} ${theme==='dark' ? styles.tags_card_dark : ''}`}>
    ...
    <>
        ...
        <div className={`${styles.filters} ${theme === 'dark' ? styles.filters_dark : ''}`}>
            <div className={`${styles.toggle} ${toggle === toggleForPostList.new ? styles.toggle_active : ''} ${theme === 'dark' ? styles.toggle_active_dark : ''}`}
                 onClick={toggleHandler(toggleForPostList.new)}>
                New
            </div>
            <div className={`${styles.toggle} ${toggle === toggleForPostList.popular ? styles.toggle_active : ''} ${theme === 'dark' ? styles.toggle_active_dark : ''}`}
